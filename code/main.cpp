...
/*bool isSame(int array[], int n){
	...
	for(int i = 1; i < n; i++){
		...
		if((map.size()==1) && array[0] == 1)
		return true;
		else return false;
	}
}*/

bool straight(int array[], int size){
	int newArray[5];
...
char* evaluatepokerhand(int cardrank[5], int cardsuite[5], int size){
	char* result[9] = {"Nothing", "Jacks or Better!", "Two Pairs!", "Straight!", "Flush!", "Full House!", "Four of a Kind!", "Straight Flush!", "Royal Flush"};
